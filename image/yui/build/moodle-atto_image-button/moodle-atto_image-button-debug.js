    ...
    TEMPLATE = '' +
        ...
        IMAGETEMPLATE = '' +
            '<img src="{{url}}" alt="{{alt}}" ' +
                ...
                '{{#if classlist}}class="attoimage {{classlist}}" {{/if}}' +
                '{{#if id}}id="{{id}}" {{/if}}' +
                '/>';
...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    initializer: function() {
        ...
        this.editor.delegate('dblclick', this._displayDialogue, '.attoimage', this);
        this.editor.delegate('click', this._handleClick, '.attoimage', this);
    ...
    _getDialogueContent: function() {
        ...
        this._form = content;
        console.log('init form', this._form);
    ...
    _getFilepickerCallback: function(element) {
        ...
        return function(params) {
            if (params.url !== '') {
                ...
                // element.one('.' + CSS.INPUTWIDTH).set('value', '');
                // element.one('.' + CSS.INPUTHEIGHT).set('value', '');
